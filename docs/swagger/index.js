...
module.exports = {
  ...
  info: {
    title: 'Rides API',
    description: 'Application that allows checking and managing information about rides of passengers',
    version: '1.0',
    contact: {
      name: 'Oleh Volvenkov',
      email: 'ovolvenkov@gmail.com',
    },
  },
  tags: [
    {
      name: 'API endpoints',
      description: 'Endpoints for managing Rides',
    },
  ],
  components: {
    schemas: {
